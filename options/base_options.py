...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='CelebA-HQ_pretrained', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--load_size', type=int, default=1024, help='Scale images to this size. The final image will be cropped to --crop_size.')  # 1024
        parser.add_argument('--crop_size', type=int, default=512, help='Crop to the width of crop_size (after initially scaling the images to load_size.)')  # 512
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='./datasets/celeba/')
